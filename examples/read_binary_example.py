...
if __name__ == "__main__":
    ...
    ptime = time.time()
    my_binary = pysp2.io.read_sp2('/nfs/gce/projects/digr/SP2Data4ANL/20181110/20181110x015.sp2b',
                                  debug=True)
    ...
    pysp2.io.write_dat(my_binary, '/nfs/gce/projects/digr/SP2Data4ANL/pyprocessing/20181110x015.dat')
